...
//                JLabel hp = new JLabel();
                ...
                enemyHP.setBounds(875, 5, 150, 50);
                ...
                //Below two lines of code courtesy of: https://stackoverflow.com/questions/641172/how-to-focus-a-jframe
            ...
            public void enemyPlayMinion(int handpos, int boardpos, int mechanic, String file) {
                if (eField[boardpos - 1].getState() == 0) {
                    ...
                    eField[boardpos - 1].setChp(eHand[handpos - 1].chp);
    ...
    public class MouseHandler extends MouseAdapter implements MouseListener {
        ...
        public void attack(int minion, int target) {
            if (field[minion - 1].getExhausted() == 0) {
                if (target == 31) {
                    System.out.println("User Attacked Enemy Hero " + target + " with User Playable " + minion + " for " + field[minion - 1].getAtk() + " damage.");
                    ...
                    System.out.println("User Attacked Enemy Playable " + target + " with User Playable " + minion + " for " + field[minion - 1].getAtk() + " damage.");

                    eField[target - 21].chp -= field[minion - 1].getAtk();

                    field[minion - 1].setChp(field[minion -1].chp -= eField[target - 21].getAtk());
                    field[minion - 1].setExhausted(1);

                    if (eField[target - 21].chp <= 0) {
                        eField[target - 21].chp = 0;
                        System.out.println("Fatal Blow to Enemy Playable " + target + ".");
                        ...
                        System.out.println("Non-Fatal Blow to Enemy Playable " + target + ", HP now " + eField[target - 21].chp + ".");
                    ...
                    if (field[minion - 1].chp <= 0) {
                        field[minion - 1].chp = 0;
                        System.out.println("Fatal Blow to Player Playable " + minion + ".");

                        switch (minion + 10) {
                            case 11:
                                cards14.setIcon(getImageIcon(new File("images/" + field[0].getName() + "_" + field[0].hp + ".png")));
                                cards14.setVisible(false);
                                break;
                            case 12:
                                cards15.setIcon(getImageIcon(new File("images/" + field[1].getName() + "_" + field[1].hp + ".png")));
                                cards15.setVisible(false);
                                break;
                            case 13:
                                cards16.setIcon(getImageIcon(new File("images/" + field[2].getName() + "_" + field[2].hp + ".png")));
                                cards16.setVisible(false);
                                break;
                            case 14:
                                cards17.setIcon(getImageIcon(new File("images/" + field[3].getName() + "_" + field[3].hp + ".png")));
                                cards17.setVisible(false);
                                break;
                            case 15:
                                cards18.setIcon(getImageIcon(new File("images/" + field[4].getName() + "_" + field[4].hp + ".png")));
                                cards18.setVisible(false);
                                break;
                            case 16:
                                cards19.setIcon(getImageIcon(new File("images/" + field[5].getName() + "_" + field[5].hp + ".png")));
                                cards19.setVisible(false);
                                break;
                            case 17:
                                cards20.setIcon(getImageIcon(new File("images/" + field[6].getName() + "_" + field[6].hp + ".png")));
                                cards20.setVisible(false);
                        }
                    } else {
                        System.out.println("Non-Fatal Blow to Player Playable " + minion + ", HP now " + field[minion - 1].chp + ".");
        ...
        public void playMinion(int handpos, int boardpos, int mechanic, String file) {
            if (field[boardpos - 1].getState() == 0) {
                ...
                field[boardpos - 1].setChp(hand[handpos - 1].chp);
        ...
        public void mouseClicked(MouseEvent e) {
            ...
            if (x > 215 && x < 300 && y > 465 && y < 600) { //space 1
                ...
                if (gameState == 1) {
                    ...
                    if (cards14.isVisible() && field[0].getExhausted() == 0) {
                        gameState = 11;
                    }
                }
            }
            ...
            if (x > 335 && x < 420 && y > 465 && y < 600) { //space 2
                ...
                if (gameState == 1) {
                    ...
                    if (cards15.isVisible() && field[1].getExhausted() == 0) {
                        gameState = 12;
                    }
                }
            }
            ...
            if (x >= 455 && x <= 540 && y >= 465 && y <= 600) { //space 3
                ...
                if (gameState == 1) {
                    ...
                    if (cards16.isVisible() && field[2].getExhausted() == 0) {
                        gameState = 13;
                    }
                }
            }
            ...
            if (x >= 573 && x <= 660 && y >= 465 && y <= 600) { //space 4
                ...
                if (gameState == 1) {
                    ...
                    if (cards17.isVisible() && field[3].getExhausted() == 0) {
                        gameState = 14;
                    }
                }
            }
            ...
            if (x > 693 && x < 779 && y > 465 && y < 600) { //space 5
                ...
                if (gameState == 1) {
                    ...
                    if (cards18.isVisible() && field[4].getExhausted() == 0) {
                        gameState = 15;
                    }
                }
            }
            ...
            if (x > 812 && x < 899 && y > 465 && y < 600) { //space 6
                ...
                if (gameState == 1) {
                    ...
                    if (cards19.isVisible() && field[5].getExhausted() == 0) {
                        gameState = 16;
                    }
                }
            }
            ...
            if (x > 931 && x < 1017 && y > 465 && y < 600) { //space 7
                ...
                if (gameState == 1) {
                    ...
                    if (cards20.isVisible() && field[6].getExhausted() == 0) {
                        gameState = 17;
                    }
                }
            }
            ...
            if (x > 306 && x < 384 && y > 280 && y < 413) {
                ...
                if (gameState > 10 && gameState < 18 && cards21.isVisible()) {
                    attack(gameState - 10, 21);
                }
            }
            if (x > 394 && x < 472 && y > 280 && y < 413) {
                ...
                if (gameState > 10 && gameState < 18 && cards22.isVisible()) {
                    attack(gameState - 10, 22);
                }
            }
            if (x > 482 && x < 560 && y > 280 && y < 413) {
                ...
                if (gameState > 10 && gameState < 18 && cards23.isVisible()) {
                    attack(gameState - 10, 23);
                }
            }
            if (x > 570 && x < 648 && y > 280 && y < 413) {
                ...
                if (gameState > 10 && gameState < 18 && cards24.isVisible()) {
                    attack(gameState - 10, 24);
                }
            }
            if (x > 658 && x < 736 && y > 280 && y < 413) {
                ...
                if (gameState > 10 && gameState < 18 && cards25.isVisible()) {
                    attack(gameState - 10, 25);
                }
            }
            if (x > 746 && x < 824 && y > 280 && y < 413) {
                ...
                if (gameState > 10 && gameState < 18 && cards26.isVisible()) {
                    attack(gameState - 10, 26);
                }
            }
            if (x > 834 && x < 912 && y > 280 && y < 413) {
                ...
                if (gameState > 10 && gameState < 18 && cards27.isVisible()) {
                    attack(gameState - 10, 27);
                }
            }
            ...
            if (e.getModifiers() == MouseEvent.BUTTON3_MASK) {
                ...
                if (x > 135 && x < 213 && y > 720 && y < 853) {
                    ...
                    cards.setIcon(getImageIcon(new File("images/" + hand[0].getName() + "_" + hand[0].getChp() + "_big.png")));
                    gameState = 100;
                } else {
                    cards.setBounds(135, 685, 78, 120);
                    cards.setIcon(getImageIcon(new File("images/" + hand[0].getName() + "_" + hand[0].getChp() + ".png")));
                    gameState = 100;
                }

                if (x > 223 && x < 301 && y > 720 && y < 853) { //hand 2
                    cards1.setBounds(500, 225, 233, 359);
                    cards1.setIcon(getImageIcon(new File("images/" + hand[1].getName() + "_" + hand[1].getChp() + "_big.png")));
                    gameState = 100;
                } else {
                    cards1.setBounds(223, 685, 78, 120);
                    cards1.setIcon(getImageIcon(new File("images/" + hand[1].getName() + "_" + hand[1].getChp() + ".png")));
                    gameState = 100;
                }

                if (x > 311 && x < 389 && y > 720 && y < 853) { //hand 3
                    cards2.setBounds(500, 225, 233, 359);
                    cards2.setIcon(getImageIcon(new File("images/" + hand[2].getName() + "_" + hand[2].getChp() + "_big.png")));
                    gameState = 100;
                } else {
                    cards2.setBounds(311, 685, 78, 120);
                    cards2.setIcon(getImageIcon(new File("images/" + hand[2].getName() + "_" + hand[2].getChp() + ".png")));
                    gameState = 100;
                }

                if (x > 399 && x < 477 && y > 720 && y < 853) { //hand 4
                    cards3.setBounds(500, 225, 233, 359);
                    cards3.setIcon(getImageIcon(new File("images/" + hand[3].getName() + "_" + hand[3].getChp() + "_big.png")));
                    gameState = 100;
                } else {
                    cards3.setBounds(399, 685, 78, 120);
                    cards3.setIcon(getImageIcon(new File("images/" + hand[3].getName() + "_" + hand[3].getChp() + ".png")));
                    gameState = 100;
                }

                if (x > 487 && x < 565 && y > 720 && y < 853) { //hand 5
                    cards4.setBounds(500, 225, 233, 359);
                    cards4.setIcon(getImageIcon(new File("images/" + hand[4].getName() + "_" + hand[4].getChp() + "_big.png")));
                    gameState = 100;
                } else {
                    cards4.setBounds(487, 685, 78, 120);
                    cards4.setIcon(getImageIcon(new File("images/" + hand[4].getName() + "_" + hand[4].getChp() + ".png")));
                    gameState = 100;
                }

                if (x > 575 && x < 653 && y > 720 && y < 853) { //hand 6
                    cards5.setBounds(500, 225, 233, 359);
                    cards5.setIcon(getImageIcon(new File("images/" + hand[5].getName() + "_" + hand[5].getChp() + "_big.png")));
                    gameState = 100;
                } else {
                    cards5.setBounds(575, 685, 78, 120);
                    cards5.setIcon(getImageIcon(new File("images/" + hand[5].getName() + "_" + hand[5].getChp() + ".png")));
                    gameState = 100;
                }

                if (x > 663 && x < 741 && y > 720 && y < 853) { //hand 7
                    cards6.setBounds(500, 225, 233, 359);
                    cards6.setIcon(getImageIcon(new File("images/" + hand[6].getName() + "_" + hand[6].getChp() + "_big.png")));
                    gameState = 100;
                } else {
                    cards6.setBounds(663, 685, 78, 120);
                    cards6.setIcon(getImageIcon(new File("images/" + hand[6].getName() + "_" + hand[6].getChp() + ".png")));
                    gameState = 100;
                }
                ...
                if (x > 135 && x < 213 && y > 0 && y < 180) {
                    ...
                    cards7.setIcon(getImageIcon(new File("images/" + eHand[0].getName() + "_" + eHand[0].getChp() + "_big.png")));
                    gameState = 100;
                } else {
                    cards7.setBounds(135, 5, 78, 120);
                    cards7.setIcon(getImageIcon(new File("images/" + eHand[0].getName() + "_" + eHand[0].getChp() + ".png")));
                    gameState = 100;
                }
                ...
                if (x > 223 && x < 301 && y > 0 && y < 180) {
                    ...
                    cards8.setIcon(getImageIcon(new File("images/" + eHand[1].getName() + "_" + eHand[1].getChp() + "_big.png")));
                    gameState = 100;
                } else {
                    cards8.setBounds(223, 5, 78, 120);
                    cards8.setIcon(getImageIcon(new File("images/" + eHand[1].getName() + "_" + eHand[1].getChp() + ".png")));
                    gameState = 100;
                }
                ...
                if (x > 311 && x < 389 && y > 0 && y < 180) {
                    ...
                    cards9.setIcon(getImageIcon(new File("images/" + eHand[2].getName() + "_" + eHand[2].getChp() + "_big.png")));
                    gameState = 100;
                } else {
                    cards9.setBounds(311, 5, 78, 120);
                    cards9.setIcon(getImageIcon(new File("images/" + eHand[2].getName() + "_" + eHand[2].getChp() + ".png")));
                    gameState = 100;
                }
                ...
                if (x > 399 && x < 477 && y > 0 && y < 180) {
                    ...
                    cards10.setIcon(getImageIcon(new File("images/" + eHand[3].getName() + "_" + eHand[3].getChp() + "_big.png")));
                    gameState = 100;
                } else {
                    cards10.setBounds(399, 5, 78, 120);
                    cards10.setIcon(getImageIcon(new File("images/" + eHand[3].getName() + "_" + eHand[3].getChp() + ".png")));
                    gameState = 100;
                }
                ...
                if (x > 487 && x < 565 && y > 0 && y < 180) {
                    ...
                    cards11.setIcon(getImageIcon(new File("images/" + eHand[4].getName() + "_" + eHand[4].getChp() + "_big.png")));
                    gameState = 100;
                } else {
                    cards11.setBounds(487, 5, 78, 120);
                    cards11.setIcon(getImageIcon(new File("images/" + eHand[4].getName() + "_" + eHand[4].getChp() + ".png")));
                    gameState = 100;
                }
                ...
                if (x > 575 && x < 653 && y > 0 && y < 180) {
                    ...
                    cards12.setIcon(getImageIcon(new File("images/" + eHand[5].getName() + "_" + eHand[5].getChp() + "_big.png")));
                    gameState = 100;
                } else {
                    cards12.setBounds(575, 5, 78, 120);
                    cards12.setIcon(getImageIcon(new File("images/" + eHand[5].getName() + "_" + eHand[5].getChp() + ".png")));
                    gameState = 100;
                }
                ...
                if (x > 663 && x < 741 && y > 0 && y < 180) {
                    ...
                    cards13.setIcon(getImageIcon(new File("images/" + eHand[6].getName() + "_" + eHand[6].getChp() + "_big.png")));
                    gameState = 100;
                } else {
                    cards13.setBounds(663, 5, 78, 120);
                    cards13.setIcon(getImageIcon(new File("images/" + eHand[6].getName() + "_" + eHand[6].getChp() + ".png")));
                    gameState = 100;
                }
                ...
                if (x > 215 && x < 300 && y > 465 && y < 600) { //space 1
                    ...
                    cards14.setIcon(getImageIcon(new File("images/" + field[0].getName() + "_" + field[0].getChp() + "_big.png")));
                    gameState = 100;
                } else {
                    cards14.setBounds(215, 470, 78, 120);
                    cards14.setIcon(getImageIcon(new File("images/" + field[0].getName() + "_" + field[0].getChp() + ".png")));
                    gameState = 100;
                }

                if (x > 335 && x < 420 && y > 465 && y < 600) { //space 2
                    cards15.setBounds(500, 225, 233, 359);
                    cards15.setIcon(getImageIcon(new File("images/" + field[1].getName() + "_" + field[1].getChp() + "_big.png")));
                    gameState = 100;
                } else {
                    cards15.setBounds(335, 470, 78, 120);
                    cards15.setIcon(getImageIcon(new File("images/" + field[1].getName() + "_" + field[1].getChp() + ".png")));
                    gameState = 100;
                }

                if (x >= 455 && x <= 540 && y >= 465 && y <= 600) { //space 3
                    cards16.setBounds(500, 225, 233, 359);
                    cards16.setIcon(getImageIcon(new File("images/" + field[2].getName() + "_" + field[2].getChp() + "_big.png")));
                    gameState = 100;
                } else {
                    cards16.setBounds(455, 470, 78, 120);
                    cards16.setIcon(getImageIcon(new File("images/" + field[2].getName() + "_" + field[2].getChp() + ".png")));
                    gameState = 100;
                }

                if (x >= 573 && x <= 660 && y >= 465 && y <= 600) { //space 4
                    cards17.setBounds(500, 225, 233, 359);
                    cards17.setIcon(getImageIcon(new File("images/" + field[3].getName() + "_" + field[3].getChp() + "_big.png")));
                    gameState = 100;
                } else {
                    cards17.setBounds(573, 470, 78, 120);
                    cards17.setIcon(getImageIcon(new File("images/" + field[3].getName() + "_" + field[3].getChp() + ".png")));
                    gameState = 100;
                }

                if (x > 693 && x < 779 && y > 465 && y < 600) { //space 5
                    cards18.setBounds(500, 225, 233, 359);
                    cards18.setIcon(getImageIcon(new File("images/" + field[4].getName() + "_" + field[4].getChp() + "_big.png")));
                    gameState = 100;
                } else {
                    cards18.setBounds(693, 470, 78, 120);
                    cards18.setIcon(getImageIcon(new File("images/" + field[4].getName() + "_" + field[4].getChp() + ".png")));
                    gameState = 100;
                }

                if (x > 812 && x < 899 && y > 465 && y < 600) { //space 6
                    cards19.setBounds(500, 225, 233, 359);
                    cards19.setIcon(getImageIcon(new File("images/" + field[5].getName() + "_" + field[5].getChp() + "_big.png")));
                    gameState = 100;
                } else {
                    cards19.setBounds(812, 470, 78, 120);
                    cards19.setIcon(getImageIcon(new File("images/" + field[5].getName() + "_" + field[5].getChp() + ".png")));
                    gameState = 100;
                }

                if (x > 931 && x < 1017 && y > 465 && y < 600) { //space 7
                    cards20.setBounds(500, 225, 233, 359);
                    cards20.setIcon(getImageIcon(new File("images/" + field[6].getName() + "_" + field[6].getChp() + "_big.png")));
                    gameState = 100;
                } else {
                    cards20.setBounds(931, 470, 78, 120);
                    cards20.setIcon(getImageIcon(new File("images/" + field[6].getName() + "_" + field[6].getChp() + ".png")));
                    gameState = 100;
                }
                ...
                if (x > 306 && x < 384 && y > 280 && y < 413) {
                    ...
                    cards21.setIcon(getImageIcon(new File("images/" + eField[0].getName() + "_" + eField[0].getChp() + "_big.png")));
                    gameState = 100;
                } else {
                    cards21.setBounds(306, 230, 78, 120);
                    cards21.setIcon(getImageIcon(new File("images/" + eField[0].getName() + "_" + eField[0].getChp() + ".png")));
                    gameState = 100;
                }

                if (x > 394 && x < 472 && y > 280 && y < 413) {
                    cards22.setBounds(500, 225, 233, 359);
                    cards22.setIcon(getImageIcon(new File("images/" + eField[1].getName() + "_" + eField[1].getChp() + "_big.png")));
                    gameState = 100;
                } else {
                    cards22.setBounds(394, 230, 78, 120);
                    cards22.setIcon(getImageIcon(new File("images/" + eField[1].getName() + "_" + eField[1].getChp() + ".png")));
                    gameState = 100;
                }

                if (x > 482 && x < 560 && y > 280 && y < 413) {
                    cards23.setBounds(500, 225, 233, 359);
                    cards23.setIcon(getImageIcon(new File("images/" + eField[2].getName() + "_" + eField[2].getChp() + "_big.png")));
                    gameState = 100;
                } else {
                    cards23.setBounds(482, 230, 78, 120);
                    cards23.setIcon(getImageIcon(new File("images/" + eField[2].getName() + "_" + eField[2].getChp() + ".png")));
                    gameState = 100;
                }

                if (x > 570 && x < 648 && y > 280 && y < 413) {
                    cards24.setBounds(500, 225, 233, 359);
                    cards24.setIcon(getImageIcon(new File("images/" + eField[3].getName() + "_" + eField[3].getChp() + "_big.png")));
                    gameState = 100;
                } else {
                    cards24.setBounds(570, 230, 78, 120);
                    cards24.setIcon(getImageIcon(new File("images/" + eField[3].getName() + "_" + eField[3].getChp() + ".png")));
                    gameState = 100;
                }

                if (x > 658 && x < 736 && y > 280 && y < 413) {
                    cards25.setBounds(500, 225, 233, 359);
                    cards25.setIcon(getImageIcon(new File("images/" + eField[4].getName() + "_" + eField[4].getChp() + "_big.png")));
                    gameState = 100;
                } else {
                    cards25.setBounds(658, 230, 78, 120);
                    cards25.setIcon(getImageIcon(new File("images/" + eField[4].getName() + "_" + eField[4].getChp() + ".png")));
                    gameState = 100;
                }

                if (x > 746 && x < 824 && y > 280 && y < 413) {
                    cards26.setBounds(500, 225, 233, 359);
                    cards26.setIcon(getImageIcon(new File("images/" + eField[5].getName() + "_" + eField[5].getChp() + "_big.png")));
                    gameState = 100;
                } else {
                    cards26.setBounds(746, 230, 78, 120);
                    cards26.setIcon(getImageIcon(new File("images/" + eField[5].getName() + "_" + eField[5].getChp() + ".png")));
                    gameState = 100;
                }

                if (x > 834 && x < 912 && y > 280 && y < 413) {
                    cards27.setBounds(500, 225, 233, 359);
                    cards27.setIcon(getImageIcon(new File("images/" + eField[6].getName() + "_" + eField[6].getChp() + "_big.png")));
                    gameState = 100;
                } else {
                    cards27.setBounds(834, 230, 78, 120);
                    cards27.setIcon(getImageIcon(new File("images/" + eField[6].getName() + "_" + eField[6].getChp() + ".png")));
                    gameState = 100;
                }
            }
        }
